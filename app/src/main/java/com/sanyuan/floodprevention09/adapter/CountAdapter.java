...
public class CountAdapter extends BaseAdapter {
    ...
    public CountAdapter(Context mContext, List<CountBean> list) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_count, null);
//            holder = new ViewHolder();
        ...
        holder.tv3.setText(bean.getTime());
