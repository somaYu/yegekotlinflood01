 ...
 */
public class PillarViewProvince extends DemoView {
    ...
    public PillarViewProvince(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public PillarViewProvince(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PillarViewProvince(Context context, AttributeSet attrs, int defStyle) {
