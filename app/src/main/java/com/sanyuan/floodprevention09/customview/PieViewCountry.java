...
// PieChart01View
public class PieViewCountry extends DemoView implements Runnable {
    ...
    public PieViewCountry(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public PieViewCountry(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PieViewCountry(Context context, AttributeSet attrs, int defStyle) {
...
//        chartData.add(new PieData("2020年", "41%", 41, Color.rgb(90, 79, 88)));
        ...
        chartData.add(new PieData("2017年", "9%", 9, Color.rgb(191, 79, 75)));
        chartData.add(new PieData("2018年", "24%", 24, Color.rgb(242, 167, 69)));
        chartData.add(new PieData("2019年", "26%", 26, Color.rgb(60, 173, 213)));
        chartData.add(new PieData("2020年", "41%", 41, Color.rgb(155, 187, 90), true));
