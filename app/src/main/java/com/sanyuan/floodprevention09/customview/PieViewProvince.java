 ...
 * @Description 饼图的例子
 */
public class PieViewProvince extends DemoView implements Runnable {
    ...
    public PieViewProvince(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public PieViewProvince(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PieViewProvince(Context context, AttributeSet attrs, int defStyle) {
...
//		chartData.add(new PieData("closed","9%" ,   9, Color.rgb(155, 187, 90)));
//        chartData.add(new PieData("2020年", "41%", 41, Color.rgb(90, 79, 88)));

        chartData.add(new PieData("2017年", "69%", 69, Color.rgb(191, 79, 75), true));
        chartData.add(new PieData("2018年", "14%", 14, Color.rgb(242, 167, 69)));
        chartData.add(new PieData("2019年", "6%", 6, Color.rgb(60, 173, 213)));
        chartData.add(new PieData("2020年", "11%", 11, Color.rgb(155, 187, 90)));
